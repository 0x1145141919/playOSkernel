...
global longmode_enter_checkpoint
...
bits 64
    ...
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 0
    sfence
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 1
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 2
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 3
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 4
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 5
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 6
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 7
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 8
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 9
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 10
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 11
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 12
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 13
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 14
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 15
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 16
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 17
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 18
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 19
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 20
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
    ...
    push rax
    mov word [longmode_enter_checkpoint.failure_final_stack_top], rsp
    mov byte [longmode_enter_checkpoint.failure_caused_excption_num], 21
    sfence
    mov byte [longmode_enter_checkpoint.failure_flags], 0x3
    hlt
